...
export default function drawLogo({
  ...
  const result = svg(
    ...
    g(
      ...
      rect({ fill: toothColor1.hex, opacity: 0.4, x: 26, y: 84, width: 16, height: 16, rx: 3 }),
      rect({ fill: toothColor2.hex, opacity: 0.4, x: 46, y: 84, width: 16, height: 16, rx: 3 }),
      rect({ fill: toothColor3.hex, opacity: 0.4, x: 66, y: 84, width: 16, height: 16, rx: 3 }),
      rect({ fill: toothColor1.hex, opacity: 0.4, x: 86, y: 84, width: 16, height: 16, rx: 3 }),
      rect({ fill: toothColor2.hex, opacity: 0.4, x: 26, y: 64, width: 16, height: 16, rx: 3 }),
      rect({ fill: toothColor3.hex, opacity: 0.4, x: 46, y: 64, width: 16, height: 16, rx: 3 }),
      rect({ fill: toothColor1.hex, opacity: 0.4, x: 66, y: 64, width: 16, height: 16, rx: 3 }),
      rect({ fill: toothColor2.hex, opacity: 0.4, x: 86, y: 64, width: 16, height: 16, rx: 3 }),
      path({
        d: [
          'M63.9142454,22',
          'C79.7144557,22',
